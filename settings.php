...
<div class="main_column column">
	...
	Modify your information then click 'Update Details' when complete
	<br>
	...
	Enter your old password, then your new password, and then click 'Update Password' when complete
	<br>
	<form action="settings.php" method="POST">
